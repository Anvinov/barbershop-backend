...
import com.bezkoder.springjwt.config.data.entity.ERole;
import com.bezkoder.springjwt.config.data.entity.Role;
import com.bezkoder.springjwt.config.data.entity.User;
import com.bezkoder.springjwt.config.data.repository.RoleRepository;
import com.bezkoder.springjwt.config.data.repository.UserRepository;
...
import com.bezkoder.springjwt.config.security.jwt.JwtUtils;
import com.bezkoder.springjwt.config.security.service.UserDetailsImpl;
...
public class AuthImpl implements AuthInt{
    ...
    public MessageResponseDTO registerUser(SignupRequestDTO signUpRequest) {
        ...
        return new MessageResponseDTO("Usuario "+user.getEmail()+" creado exitosamente");
    }
